...
import { ArrowLeft, Code, Plus, Trash2, AlertCircle, CheckCircle, HelpCircle } from 'lucide-react';
...
function AdminPanel() {
  ...
  const getFlatErrors = (errs) => {
    ...
    const traverse = (obj, path = "") => {
      if (!obj) return;
      if (obj.message) {
        // Translate array index paths to user friendly strings
        let cleanPath = path
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-base-300 via-base-200 to-base-300 pb-16">
      ...
      <div className="container mx-auto max-w-5xl px-4">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-extrabold text-base-content mb-2">Create New Challenge</h1>
          <p className="text-base-content/60">Design algorithmic problems, set up test suites, and provide evaluation solutions.</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="card bg-base-100 shadow-xl border border-base-300 p-6">
            ...
            <div className="space-y-5">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  {...register('title')}
                  placeholder="Enter problem title (e.g. Reverse Linked List)"
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  placeholder="Describe the problem, input/output specifications, constraints, etc."
          ...
          <button type="submit" disabled={isSubmitting} className="btn btn-primary btn-lg w-full rounded-2xl shadow-lg hover:shadow-primary/30 transition-all font-bold text-base gap-2">
            {isSubmitting ? <span className="loading loading-spinner"></span> : (
              <>
                <CheckCircle size={20} />
                <span>Create Problem & Test Solution</span>
              </>
            )}
          </button>
        </form>
